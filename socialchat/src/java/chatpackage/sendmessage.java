...
public class sendmessage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String msg = request.getParameter("_msg");
           ...
           try
            ...
            if(!msg.equals(x))
            {
            st.executeUpdate("insert into "+groupname+" values('"+username+"','"+msg+"') ");
            out.println("Updated");
            }
           ...
           catch (Exception ex)
            {
                ...
                /*out.println("<h1>This Username is not AVAILABLE! Choose another ONE </h1>");
                   out.println("<a href=\"http://localhost:8080/socialchat/.jsp\">Sign Up Again</a>");*/
            }
