...
"</style>");
            ...
            String fname = request.getParameter("_firstname");
            String lname = request.getParameter("_lastname");
            String uname = request.getParameter("_username");
            String password = request.getParameter("_password");
            String cnfpassword = request.getParameter("_confirmpassword");
           ...
           Statement st= conn.createStatement();
            st.executeUpdate("insert into userdata values ('"+fname+"','"+lname+"','"+uname+"','"+password+"')");
            ...
            catch (Exception ex)
            {
                ...
                out.print("<div class=\"errortext\">This Username is not AVAILABLE! </div>");
